                  ...
                  <div className="w-full max-w-xs">
                    ...
                    >
                      <TabsList className="w-full rounded-2xl">
                        ...
                        <TabsTrigger className="w-full rounded-md text-xs data-[state=active]:bg-indigo-500/10 data-[state=active]:text-indigo-400 data-[state=active]:border-border/40 transition-all" value="production">
                          Prod
                        </TabsTrigger>
                        <TabsTrigger className="w-full rounded-md text-xs data-[state=active]:bg-indigo-500/10 data-[state=active]:text-indigo-400 data-[state=active]:border-border/40 transition-all" value="integration">
                          Dev
                        </TabsTrigger>
                      </TabsList>
                    </Tabs>
