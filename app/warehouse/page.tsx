                    ...
                    <div className="w-full max-w-xs">
                      ...
                      >
                        <TabsList className="w-full rounded-md bg-accent/40 border border-border/40 p-1 text-muted-foreground">
                          ...
                          <TabsTrigger className="w-full rounded-md text-xs data-[state=active]:bg-indigo-500/10 data-[state=active]:text-indigo-400 data-[state=active]:border-border/40 transition-all" value="aws-s3">
                            S3
                          </TabsTrigger>
                          <TabsTrigger className="w-full rounded-md text-xs data-[state=active]:bg-indigo-500/10 data-[state=active]:text-indigo-400 data-[state=active]:border-border/40 transition-all" value="gcp-storage">
                            GCP
                          </TabsTrigger>
                        </TabsList>
                      </Tabs>
